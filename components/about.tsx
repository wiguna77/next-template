...
<div className="flex flex-col md:flex-row md:space-x-5 space-y-5 md:space-y-0" id='community'>
  <div className="w-full md:w-1/2 p-6 text-center md:text-right border border-white bg-black bg-opacity-50 rounded-lg">
    ...
    <div className="flex space-x-4 mt-4 justify-center md:justify-end flex-wrap">
  ...
  <div className="w-full md:w-1/2 p-6 text-center md:text-right border border-white bg-black bg-opacity-50 rounded-lg" id='buy'>
    ...
    <div className="flex justify-center md:justify-end flex-wrap space-x-2 md:space-x-4 mt-4">
      {/* BirdEye */}
